...
static const Bool viewtonewtag            = True;   /* Follow client to new tag on tag switch */
...
static const char *fonts[]                = {       /* fonts is self-explanatory */
  ...
  "JetBrains Mono:style=Regular:size=15.5:antialias=true:autohint=true",
...
static Button buttons[] = {   /*  <-  This are the bar buttons and the mouse button functions.
  ...
  { ClkLtSymbol,    0,                Button2,    spawn,              SHCMD("notify-layout") },
